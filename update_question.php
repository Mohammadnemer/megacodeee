...
<body>
	<div id="div1">
		...
		<div id="div2">
			<section>
				<form method="post" action="update_question.php?select=<?php  echo $_POST['typee'];?>">
				...
				<select name="typee">
					...
					<button class="submit-btn" name='view' >View</button>
				</div>
				  	<table>
				  		...
				  		print("<tr>
				  				...
				  				<td><button class='submit-btn' type='submit' name='delete' value='$r[0]' class='submit-btn'>Delete</button> </td>
				  		...
				  		if(isset($_POST['delete'])){
				  			extract($_POST);
				  			$se=$_GET['select'];
				  			$sql_de="DELETE FROM $se where id=$delete";
